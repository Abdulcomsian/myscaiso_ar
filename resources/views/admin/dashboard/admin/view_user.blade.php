                            ...
                            <!--<td>{{---$item->id---}}{{$count}}</td>-->
                                ...
                                <td><?php
                                    if (isset($item->profile_image)) { ?>
                                        {{-- $logo = "<img src='https://ar.myscaiso.com/public/" . $item->profile_image . "' width='60px'>"; --}}
...
//console.log(data.company_address);
                ...
                // let logo_src = "https://ar.myscaiso.com/public/" + data.profile_image;
                ...
                if (data.iso9001_certificate != null) {
                    ...
                    $(".iso9001").show();
                    $("#view_9001").append("<a target='_blank' href='https://ar.myscaiso.com/public/" + data.iso9001_certificate + "'>تيقن</a>");
                } else {
                    $(".iso9001").hide();
                }
                if (data.iso14001_certificate != null) {
                    // $('#iso14001_certificate').addClass('has_file');
                    $("#view_4001").append("<a target='_blank' href='https://ar.myscaiso.com/public/" + data.iso14001_certificate + "'>تيقن</a>");
                    $(".iso4001").show();
                } else {
                    $(".iso4001").hide();
                }
                if (data.iso45001_certificate != null) {
                    ...
                    $("#view_45001").append("<a target='_blank' href='https://ar.myscaiso.com/public/" + data.iso45001_certificate + "'>تيقن</a>");
                    $(".iso45001").show();
            ...
            function viewDetails(data) 
            {
                ...
                if (data.iso9001_certificate != null) {
                    $("#v_9001").append("<a target='_blank' href='https://ar.myscaiso.com/public/" + data.iso9001_certificate + "'>View</a>");
                } else {
                    $('#v_9001').append('Not Found');
                }
                if (data.iso14001_certificate != null) {
                    $("#v_4001").append("<a target='_blank' href='https://ar.myscaiso.com/public/" + data.iso14001_certificate + "'>View</a>");
                } else {
                    $('#v_4001').append('Not Found');
                }
                if (data.iso45001_certificate != null) {
                    $("#v_45001").append("<a target='_blank' href='https://ar.myscaiso.com/public/" + data.iso45001_certificate + "'>View</a>");
                } else {
