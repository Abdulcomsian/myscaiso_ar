                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a class="btn btn-sm btn-clean btn-icon btn-icon-md" title="Edit"
                                        href="{{ url('quick_link_edit/' . $link->id) }}">
                                    ...
                                    <a href="javascript:;" data-toggle="modal" data-target="#delete-{{ $link->id }}"
                                    ...
                                    <div class="modal fade" id="delete-{{ $link->id }}" tabindex="-1"
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <form action="{{ url('/quick_link_delete/' . $link->id) }}"
                                                        method="POST">
                                                        @csrf
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="javascript:;" data-toggle="modal"
                                        data-target="#delete-category-{{ $cat->id }}"
                                        class="btn btn-sm btn-clean btn-icon btn-icon-md" title="Delete"> <span
                                            class="svg-icon svg-icon-md"> <svg xmlns="http://www.w3.org/2000/svg"
                                                xmlns:xlink="http://www.w3.org/1999/xlink" width="18px" height="18px"
                                                viewBox="0 0 24 24" version="1.1">
                                    ...
                                    <div class="modal fade" id="delete-category-{{ $cat->id }}" tabindex="-1"
                                        role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                ...
                                                <div class="modal-footer">
                                                    <form action="{{ url('/quick_link_category_delete') }}"
                                                        method="POST">
                                                        @csrf
