...
<div class="kt-content  kt-grid__item kt-grid__item--fluid" id="kt_content">
	...
	<section id="procedure_section">
		...
		<div class="row">
			<div class="col-lg-12">
			<p>This section can be considered as a diary shown on your MyISOArabia control panel. Simply add items that need to be recalled on a regular basis, such as when management reviews are due, or calibration audits are required.</p>
                    	...
                    	<div class="requirments_from_div">
                    		<form>
                    			<div class="form-group">
									...
									<input type="email" class="form-control" aria-describedby="emailHelp" placeholder="Enter Requirement:" required>
								</div>
								<div class="row">
									<div class="col-lg-6">
										<div class="form-group">
											<label>Requirement Completion Date of the Activity (YYYY/MM/DD):</label>
											<input type="date"  max="2999-12-31" class="form-control" aria-describedby="emailHelp" placeholder="Enter Requirement:" required>
										</div>
									</div>
									<div class="col-lg-6">
										<div class="form-group">
											<label>RPeriodicity (Months):</label>
											<input type="number" min="1" max="12" class="form-control" aria-describedby="emailHelp" placeholder="Enter Months:" required>
										</div>
									</div>
								</div>
		...
		<div class="modal-content">
			...
			<div class="modal-body">
				<form>
					...
					<div class="form-group">
						<label>Requirement Completion Date of the Activity (YYYY/MM/DD):</label>
						<input type="date"  max="2999-12-31" class="form-control" aria-describedby="emailHelp" placeholder="Enter Requirement:">
					</div>
					<div class="form-group">
						<label>RPeriodicity (Months):</label>
