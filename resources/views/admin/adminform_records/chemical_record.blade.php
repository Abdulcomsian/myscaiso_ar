...
@section('content')
	...
	<p>لإضافة سجل، يرجى النقر على زر "إضافة COSHH". لتعديل سجل، يرجى النقر على أيقونة التعديل الخاصة بالقيد المراد تعديله أو حذفه. </p>
                    <div class="procedure_div">
                        ...
                        <div class="process_interested_from_div" style="display:none; height: 1261px; margin-top: 15px;">
                    ...
                    <div class="procedure_div">
                        <div class="requirments_table_div">
                            <div class="d-flex justify-content-between mb-2">
                                <h4>إجمالي الضوابط الكيميائية المدرجة</h4>
                                ...
                                <table
                                    ...
                                    <tbody>
                                        ...
                                        @foreach ($chemical as $data)
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <button class="btn btn-sm btn-clean btn-icon btn-con-md"
                                                        title="View" onclick="viewinterested({{ $data }});">
                                                    ...
                                                    <button data-toggle="modal"
                                                        data-target="#deleteChemechal_id{{ $data->id }}"
                                            ...
                                            <div class="modal fade" id="deleteChemechal_id{{ $data->id }}"
