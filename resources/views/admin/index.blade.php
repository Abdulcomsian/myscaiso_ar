											...
											<div class="kt-widget17">
												...
												<div class="kt-widget17__stats">
													<div class="kt-widget17__items">
														...
														<div class="kt-widget17__item bg-light-primary">
															<span class="kt-widget17__icon">
											...
											<table class="table table-striped- table-bordered table-hover table-checkable" id="kt_table_agent">
												...
												<tbody>
													<tr>
														...
														<td>1</td>
														<td>2019-03-16</td>
														<td><a href="javascript:;" data-toggle="modal" data-target="#calibrationModal" class="btn btn-sm btn-clean btn-icon btn-icon-md" title="Delete">		
