...
@yield('myscript')
		...
		@if(Request::is('user*') || Request::is('customer*') || Request::is('agent*'))
			...
			<!--begin::Page Scripts(used by this page) -->
			<!-- <script src="{{ asset('/assets/dropzone/dist/dropzone.js') }}" type="text/javascript"></script> -->
		...
		<script type="text/javascript">
			jQuery('.addPlane').click(function(){
				...
				var cell1 = row.insertCell(0);
		      	...
		      	cell4.innerHTML='<div class="input-group date"><input type="text" name="dob" class="form-control" readonly value="{{\Carbon\Carbon::now()->format('d/m/Y')}}" id="dob" /><div class="input-group-append"><span class="input-group-text"><i class="la la-calendar"></i></span></div></div>';
