<!-- begin:: Header Mobile -->
 <div id="kt_header_mobile" class="kt-header-mobile  kt-header-mobile--fixed ">
     <div class="kt-header-mobile__logo">
         <a href="<?php echo e(url('/home')); ?>">
             ...
             <img alt="Logo" src="<?php echo e(Auth::user()->profile_image); ?>" width="120" />
         ...
         <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor kt-wrapper" id="kt_wrapper">
             ...
             <div id="kt_header" class="kt-header kt-grid__item  kt-header--fixed ">
                     ...
                     <div id="kt_header_menu"
                         ...
                         <ul class="kt-menu__nav ">
                             <li
                                 ...
                                 <a href="<?php echo e(url('/home')); ?>" class="kt-menu__link"><span class="kt-menu__link-text">My
                                         ISO Online</span></a>
                                ...
                                <div class="kt-header__topbar-item dropdown" style="    margin-top: 10px;margin-right: 10px;">
                                    <div class="kt-header__topbar-wrapper" data-offset="30px,0px" aria-expanded="true">
                                        <span class="kt-header__topbar-icon kt-pulse kt-pulse--brand">
                                            ...
                                            <?php if(Auth::user()->member_scaiso==1): ?>
                                            <span class="kt-subheader__desc"><img src="<?php echo e(asset('assets/media/logos/sca-iso-final-logo.png')); ?>" width="180px"> </span>	
                                            <?php endif; ?>
                 ...
                 <div class="kt-header__topbar">
                     ...
                     <!--begin: Notifications
       <a href="<?php echo e(url('/inboxmessage')); ?>">
         ...
         <!--
                ...
                <span class="kt-badge kt-badge--dot kt-badge--notify kt-badge--sm kt-badge--brand"></span>
                     ...
                     <div class="kt-header__topbar-item kt-header__topbar-item--user">
                         ...
                         <div
                             class="dropdown-menu dropdown-menu-fit dropdown-menu-anim dropdown-menu-top-unround dropdown-menu-xl">
                             ...
                             <div class="kt-user-card kt-user-card--skin-dark kt-notification-item-padding-x"
                                 ...
                                 <div class="kt-user-card__avatar">
                                     <img class="kt-hidden" alt="Pic"
                                         src="<?php echo e(asset(Auth::user()->user_image)); ?>" />
             ...
             <div class="kt-grid__item kt-grid__item--fluid kt-grid kt-grid--hor">
                 ...
                 <div class="kt-subheader   kt-grid__item" id="kt_subheader">
                     <div class="kt-subheader__main">
                         <h3 class="kt-subheader__title"><?php echo e(Auth::user()->company_name); ?></h3>
                         <span class="kt-subheader__separator kt-subheader__separator--v"></span>
                         <span class="kt-subheader__desc"><b>هوية الشركة:</b> <?php echo e(Auth::user()->order_number); ?> </span>
                             ...
                             <span class="kt-subheader__separator kt-subheader__separator--v">
                                 <p class="kt-subheader__title">
                                     ...
                                     <?php
                                         ...
                                         } elseif ($iso9001 != null && $iso14001 == null && $iso45001 == null) {
                                             $minValue = $x;
 ...
 <!-- end::Scrolltop -->
<?php /**PATH C:\xampp\htdocs\myiso_ar\resources\views/dashboard/includes/primary-header.blade.php ENDPATH**/ ?>