                ...
                <div class="kt-portlet__head-toolbar">
                    <div class="kt-portlet__head-wrapper">
                        <div class="kt-portlet__head-actions">
                            ...
                            &nbsp;
                            <a href="#" class="btn btn-brand btn-elevate btn-icon-sm mx-2" data-toggle="collapse"
                                data-target="#new_faq">
            ...
            <?php if($message = Session::get('msg')): ?>
                <div class="row">
                    <div class="col-md-11 pl-4 ml-4 mt-4">
                        <div class="alert alert-success alert-dismissible"><?php echo e($message); ?> &nbsp; <a href="#"
            ...
            <div class="row">
                <div class="col-md-6">
                    <div id="new_faq" class="collapse p-4">
                        <h3>إضافة رابط سريع جديد</h3>

                        <form action="<?php echo e(url('/add_quick_link')); ?>" method="POST">
                ...
                <div class="col-md-6">
                    <div id="new_faq_cate" class="collapse  p-4">
                        <h3>إضافة فئة جديدة للروابط السريعة</h3>
                        <form action="<?php echo e(url('/add_quicklink_cate')); ?>" method="POST">
                            <?php echo csrf_field(); ?> <div class="form-group">
            ...
            <div class="kt-portlet__body">
                ...
                <table class="table table-striped- table-bordered table-hover table-sm table-checkable" id="kt_table_user">
                    ...
                    <tbody>
                        ...
                        <?php $__currentLoopData = $quick_links; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $link): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php $count++; ?>
                            <tr>

                                <th style="text-align:center"><?php echo e($count); ?></th>

                                <th><a href="<?php echo e($link->link); ?>" target="_blank"><?php echo e($link->title); ?></a></th>

                                <th>
                                    <?php $__currentLoopData = $all_cate; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cate): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        <?php if($link->category == $cate->id): ?>
                                ...
                                <td>
                                    ...
                                    <a class="btn btn-sm btn-clean btn-icon btn-icon-md" title="Edit"
                                        href="<?php echo e(url('quick_link_edit/' . $link->id)); ?>">
                                    ...
                                    <a href="javascript:;" data-toggle="modal" data-target="#delete-<?php echo e($link->id); ?>"
                                    ...
                                    <div class="modal fade" id="delete-<?php echo e($link->id); ?>" tabindex="-1"
                                        role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLabel">جارٍ حذف الرابط</h5>
                                                ...
                                                <div class="modal-footer">
                                                    <form action="<?php echo e(url('/quick_link_delete/' . $link->id)); ?>"
                                                        method="POST">
                                                        <?php echo csrf_field(); ?>
        ...
        <div class="kt-portlet kt-portlet--mobile">
            ...
            <div class="kt-portlet__body">
                ...
                <table class="table table-striped- table-bordered table-hover table-sm table-checkable"
                    ...
                    <tbody>
                        <?php $count = 0; ?>
                        <?php $__currentLoopData = $all_cate; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <?php $count++; ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="javascript:;" data-toggle="modal"
                                        data-target="#delete-category-<?php echo e($cat->id); ?>"
                                        class="btn btn-sm btn-clean btn-icon btn-icon-md" title="Delete"> <span
                                            class="svg-icon svg-icon-md"> <svg xmlns="http://www.w3.org/2000/svg"
                                                xmlns:xlink="http://www.w3.org/1999/xlink" width="18px" height="18px"
                                                viewBox="0 0 24 24" version="1.1">
                                    ...
                                    <div class="modal fade" id="delete-category-<?php echo e($cat->id); ?>" tabindex="-1"
                                        role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                ...
                                                <div class="modal-footer">
                                                    <form action="<?php echo e(url('/quick_link_category_delete')); ?>"
                                                        method="POST">
                                                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.dashboard.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\myiso_ar\resources\views/admin/dashboard/admin/view_quick_links.blade.php ENDPATH**/ ?>