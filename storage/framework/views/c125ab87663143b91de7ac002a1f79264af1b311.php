            ...
            <div class="row">
                <div class="col-md-6">
                    <div id="new_video" class="collapse p-4">
                        ...
                        <form action="<?php echo e(url('/add_video')); ?>" method="POST" enctype="multipart/form-data">
                            <?php echo csrf_field(); ?>
                            ...
                            <tr>
                                ...
                                <th>
                                    <video width="440" height="180" controls>
                                        <source src="<?php echo e(url('public/uploads/explainer_videos/' . $video->video)); ?>"
                                            type="video/mp4">
                                ...
                                <td>
                                    ...
                                    <!----- <a class="btn btn-sm btn-clean btn-icon btn-icon-md" title="Edit" href="<?php echo e(url('video_edit/' . $video->id)); ?>">
                                    ...
                                    <a href="javascript:;" data-toggle="modal" data-target="#delete-<?php echo e($video->id); ?>"
                                    ...
                                    <div class="modal fade" id="delete-<?php echo e($video->id); ?>" tabindex="-1"
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <form action="<?php echo e(url('/video_delete/' . $video->id)); ?>" method="POST">
                                                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.dashboard.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\myiso_ar\resources\views/admin/dashboard/admin/view_videos.blade.php ENDPATH**/ ?>