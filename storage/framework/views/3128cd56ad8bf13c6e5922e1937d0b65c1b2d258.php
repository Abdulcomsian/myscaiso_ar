            ...
            <div class="row">
                <div class="col-md-6">
                    <div id="new_faq" class="collapse p-4">
                        <h3>أضف أسئلة وأجوبة جديدة</h3>

                        <form action="<?php echo e(url('/add_faq')); ?>" method="POST">
                                ...
                                <div class="col-lg-12">
                                    <div class="form-group">
                                        ...
                                        <select required name="category" id="category" class="form-control">
                                            <option disabled="disabled" value="">اختر الفئة</option>
                ...
                <div class="col-md-6">
                    <div id="new_faq_cate" class="collapse  p-4">
                        <h3>إضافة فئة الأسئلة الشائعة الجديدة</h3>
                        <form action="<?php echo e(url('/add_faq_cate')); ?>" method="POST">
                            <?php echo csrf_field(); ?> <div class="form-group">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a class="btn btn-sm btn-clean btn-icon btn-icon-md" title="Edit"
                                        href="<?php echo e(url('faq_edit/' . $faq->id)); ?>">
                                    ...
                                    <a href="javascript:;" data-toggle="modal" data-target="#delete-<?php echo e($faq->id); ?>"
                                    ...
                                    <div class="modal fade" id="delete-<?php echo e($faq->id); ?>" tabindex="-1"
                                        role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="exampleModalLabel">حذف الأسئلة الشائعة</h5>
                                                ...
                                                <div class="modal-footer">
                                                    <form action="<?php echo e(url('/faq_delete/' . $faq->id)); ?>" method="POST">
                                                        <?php echo csrf_field(); ?>
                        ...
                        <?php $__currentLoopData = $all_cate; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cat): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <!--<a class="btn btn-sm btn-clean btn-icon btn-icon-md" title="Edit" href="<?php echo e(url('cat_edit/' . $cat->id)); ?>">-->
                                    ...
                                    <div class="modal fade" id="delete-category-<?php echo e($cat->id); ?>" tabindex="-1"
                                        ...
                                        <div class="modal-dialog" role="document">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <form action="<?php echo e(url('/cat_delete/' . $cat->id)); ?>" method="POST">
                                                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('admin.dashboard.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\myiso_ar\resources\views/admin/dashboard/admin/view_faqs.blade.php ENDPATH**/ ?>