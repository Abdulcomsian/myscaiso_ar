                        ...
                        <div class="kt-widget17">
                            ...
                            <div class="kt-widget17__stats">
                                <div class="kt-widget17__items">
                                    <a href="<?php echo e(url('quality_manual')); ?>" class="newWidth">
                                        <div class="kt-widget17__item newColor">
                                            <span class="kt-widget17__icon">
                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                    ...
                                                    <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                                        ...
                                                        <rect id="Rectangle-Copy-2" fill="#fff" opacity="0.3"
                                            ...
                                            <span class="kt-widget17__subtitle text-warning">
                                                    ...
                                                    الإجراءات والنماذج الرئيسية
                                                
                                            </span>
                                        </div>
                                    </a>
                                    <a href="<?php echo e(url('sale_processes')); ?>" class="newWidth">
                                        <div class="kt-widget17__item newColor">
                                            <span class="kt-widget17__icon">
                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                    xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px"
                                ...
                                <div class="kt-widget17__items">
                                    <a href="<?php echo e(url('documented_information')); ?>" class="newWidth">
                                        <div class="kt-widget17__item newColor">
                                            <span class="kt-widget17__icon">
                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                    xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px"
                                    ...
                                    <a href="<?php echo e(url('requirements_aspect')); ?>" class="newWidth">
                                        <div class="kt-widget17__item newColor">
                                            <span class="kt-widget17__icon">
                                                <span
                                                    class="svg-icon svg-icon-primary svg-icon-2x"><!--begin::Svg Icon | path:/var/www/preview.keenthemes.com/metronic/releases/2020-09-29-132851/theme/html/demo1/dist/../src/media/svg/icons/Files/File.svg--><svg
                                                        ...
                                                        <g stroke="none" stroke-width="1" fill="none"
                                                            ...
                                                            <rect fill="#fff" x="6" y="11" width="9" height="2"
                                                                rx="1" />
                                                            <rect fill="#fff" x="6" y="15" width="5" height="2"
                                                                rx="1" />
                                                        </g>
                                ...
                                <div class="kt-widget17__items">
                                    <a href="<?php echo e(url('work_instruction')); ?>" style="width: 100%;">
                                        <div class="kt-widget17__item newColor">
                                            <span class="kt-widget17__icon">
                                                <svg xmlns="http://www.w3.org/2000/svg"
                                                    xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px"
            ...
            <div class="col-xl-8">
                            ...
                            <tbody>
                                ...
                                <?php $__currentLoopData = $requirement; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    ...
                                    <tr>
                                        ...
                                        <?php $d = strtotime("+$data->periods months",strtotime($data->completion_date)); ?>
                                        <td><?php echo e(date('d/m/Y', $d)); ?></td>
                                        <!--<td><?php echo e($data->due_date); ?></td>-->
                                        <td><a href="#" data-id="<?php echo e($data->id); ?>" class="delete_requirement"
                    ...
                    <div class="kt-portlet__body table-responsive">
                        ...
                        <table class="table table-striped- table-bordered table-hover table-checkable"
                            ...
                            <tbody>
                                ...
                                <?php $counter = 0; ?>
                                <?php $__currentLoopData = $calibration; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php $counter++; ?>


                                    <tr>
                                        <td> <?php echo e($counter); ?></td>
                                        <td><?php echo e($data->equipment); ?></td>
                                        <td><?php echo e($data->serialNum); ?></td>
                                        <!--<?php $d = strtotime("+$data->calibratedDate months",strtotime($data->calibratedDate)); ?>-->
                                        <!--                 <td><?php echo e(date('d/m/Y', $d)); ?></td>-->
                                        <td><?php echo e(date('d/m/Y', strtotime($data->calibratedDate))); ?></td>
                                        <td><?php echo e($data->freq); ?></td>
                                        <?php
                                        $d = strtotime("+$data->freq months", strtotime($data->calibratedDate));
                                        ?>
                                        <td> <?php echo e(date('d/m/Y', $d)); ?></td>
                                        <td><a href="javascript:;" data-toggle="modal" data-id="<?php echo e($data->id); ?>"
                        ...
                        <div class="kt-widget17 p-4">
                            ...
                            <div class="row ml-0 mr-0 table-responsive">
                                ...
                                <table class="table table-striped- table-bordered table-hover table-checkable"
                                    ...
                                    <tbody>
                                        <?php if($user['iso9001_certificate']): ?>
                                            <tr>
                                                <th>ISO9001</th>
                                                <td>
                                                    <a href="<?php echo e($user['iso9001_certificate']); ?>" target="_blank">
                                                        <i class="far fa-file-pdf fa-2x" style="color:red;"></i>
                                                    </a>
                                                </td>
                                                <td><?php echo e($user['iso9001_description']); ?></td>
                                                <td><?php echo e(date('d/m/Y', strtotime($user['iso9001_expirydate']))); ?></td>
                                            </tr>
                                        <?php endif; ?>
                                        <?php if($user['iso14001_certificate']): ?>
                                            <tr>
                                                <th>ISO14001</th>
                                                <td>
                                                    <a href="<?php echo e($user['iso14001_certificate']); ?>" target="_blank">
                                                        <i class="far fa-file-pdf fa-2x" style="color:red;"></i>
                                                    </a>
                                                </td>
                                                <td><?php echo e($user['iso14001_description']); ?></td>
                                                <td><?php echo e(date('d/m/Y', strtotime($user['iso14001_expirydate']))); ?></td>
                                            </tr>
                                        <?php endif; ?>
                                        <?php if($user['iso45001_certificate']): ?>
                                            <tr>
                                                <th>ISO45001</th>
                                                <td>
                                                    <a href="<?php echo e($user['iso45001_certificate']); ?>" target="_blank">
                                                        <i class="far fa-file-pdf fa-2x" style="color:red;"></i>
                                                    </a>
                                                </td>
                                                <td><?php echo e($user['iso45001_description']); ?></td>
                                                <td><?php echo e(date('d/m/Y', strtotime($user['iso45001_expirydate']))); ?></td>
                                            </tr>
                                        <?php endif; ?>
                                    </tbody>
                                </table>
                ...
                <div class="kt-portlet kt-portlet--height-fluid sd">
                    ...
                    <div class="kt-portlet__body kt-portlet__body--fit">
                        <div class="kt-widget17 p-4">
                            <div class="row ml-0 mr-0 table-responsive">
								<?php if(!empty($user['audit_report'])): ?>
									<a href="public/<?php echo e($user['audit_report']); ?>" target="_blank" class="text-dark ml-2">
                    ...
                    <div class="kt-portlet__body kt-portlet__body--fit">
                        <div class="kt-widget17 p-4">
                            <div class="row ml-0 mr-0 table-responsive">
                                <?php if(!empty($user['audit_comment'])): ?>
                               <?php echo e($user['audit_comment']); ?>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <form action="<?php echo e(route('deletecaliberinfo')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('dashboard.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\myiso_ar\resources\views/dashboard/index.blade.php ENDPATH**/ ?>