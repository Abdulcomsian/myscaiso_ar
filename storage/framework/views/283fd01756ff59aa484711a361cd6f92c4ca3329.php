					...
					<div class="kt-grid__item kt-grid__item--fluid kt-login__wrapper">
						<div class="kt-login__container">
							<div class="kt-login__logo">
								<a href="#">
									<img src="<?php echo e(asset('assets/media/logos/ISOOnline Arabic Logo.jpg')); ?>" class="img-fluid">
								</a>
							</div>
...
unset($__errorArgs, $__bag); ?>" type="email"  placeholder="عنوان البريد الإلكتروني" name="email" autocomplete="off" value="<?php echo e(old('email')); ?>" required autocomplete="email" autofocus>
									</div>
									<div class="input-group">
										<input class="form-control" type="password" placeholder="كلمة المرور" name="password" class="form-control <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="name" value="<?php echo e(old('name')); ?>" required autocomplete="name" autofocus>
									...
									<div class="input-group">
										<input  placeholder="عنوان البريد الإلكتروني"  autocomplete="off" class="form-control <?php $__errorArgs = ['email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="email" value="<?php echo e(old('email')); ?>" required autocomplete="email">
									...
									<div class="input-group">
										<input  type="password" placeholder="كلمة المرور" class="form-control <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" name="password" required autocomplete="password">
							...
							<!-- reCAPTCHA script -->
							<script src="https://www.google.com/recaptcha/api.js?render=<?php echo e(config('services.captcha.sitekey')); ?>"></script>

							<script>
								grecaptcha.ready(function() {
									grecaptcha.execute('<?php echo e(config('services.captcha.sitekey')); ?>', {action: 'reset_password'}).then(function(token) {
							...
							<div class="kt-login__forgot">
								...
								<form class="kt-form" action="<?php echo e(route('password.reset.email')); ?>" method="POST">
									...
									<div class="input-group">
										...
										<div class="alert alert-danger"><?php echo e($errors->first('recaptcha')); ?></div>
									<?php endif; ?>
									</div>
								...
								<?php if($errors->has('recaptcha')): ?>
									<div class="alert alert-danger mt-2"><?php echo e($errors->first('recaptcha')); ?></div>
								<?php endif; ?>
							</div>
...
<?php /**PATH C:\xampp\htdocs\myiso_ar\resources\views/auth/login.blade.php ENDPATH**/ ?>