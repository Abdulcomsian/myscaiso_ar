...
<html lang="en">
	...
	<head>
       ...
       <script type="text/javascript" charset="utf8" src="https://cdn.datatables.net/1.11.5/js/jquery.dataTables.min.js"></script>
		...
		<!-- <link href="<?php echo e(asset('/assets/jQuery-Multiple-Select/dist/css/bootstrap-multiselect.min.css')); ?>" rel="stylesheet" type="text/css" /> -->
		<link href="<?php echo e(asset('/assets/jquery.multiselect.css')); ?>" rel="stylesheet" type="text/css" />
	...
	<!-- end::Head -->
<?php /**PATH C:\xampp\htdocs\myscaiso_ar\resources\views/admin/dashboard/includes/head.blade.php ENDPATH**/ ?>