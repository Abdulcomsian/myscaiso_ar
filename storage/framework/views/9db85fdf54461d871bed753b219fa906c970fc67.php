...
<?php $__env->startSection('content'); ?>
            ...
            <div class="row text-right">
                <div class="col-lg-12">
                    ...
                    <?php if(Session::has('Error')): ?>
                        <h5 class="text-danger"> <?php echo e(Session::get('Error')); ?> </h5>
                    <?php endif; ?>
                    <div class="procedure_div">
                        ...
                        <div class="employee_from_div">
                            <form method="POST" action="<?php echo e(route('employee')); ?>" enctype="multipart/form-data"
                                class="addForm">
                                <?php echo csrf_field(); ?>
                                <div class="row">
             ...
             <div class="col-lg-6">
                    ...
                    <div class="procedure_div m-t-20">
                        ...
                        <div class="employee_skill_from_div">
                            <form action="<?php echo e(route('empSkills')); ?>" method="POST">
                                <?php echo csrf_field(); ?>
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                            ...
                                            <select name="empid" required class="form-control">
                                                ...
                                                <?php if(isset($userinfo) && $userinfo != ''): ?>
                                                    <?php $__currentLoopData = $userinfo; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($item->id); ?>" title="<?php echo e($item->first_name); ?>">
                                                            <?php echo e($item->empNumber . ' (' . $item->first_name . ')'); ?></option>
                    ...
                    <div class="procedure_div m-t-20">
                        ...
                        <div class="employee_record_from_div">
                            <form action=" <?php echo e(route('empTraining')); ?> " method="POST" enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group">
                                                ...
                                                <?php if(isset($userinfo) && $userinfo != ''): ?>
                                                    <?php $__currentLoopData = $userinfo; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($item->id); ?>"
                                                            title="<?php echo e($item->first_name); ?>">
                                                            <?php echo e($item->empNumber . ' (' . $item->first_name . ')'); ?></option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                <?php endif; ?>
                                            </select>
                                ...
                                <table
                                    ...
                                    <tbody>
                                        ...
                                        <?php $__currentLoopData = $userinfo; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                <!--<td> <?php echo e($n); ?></td>-->
                                                <td> <?php echo e($item->empNumber); ?></td>
                                                <td> <?php echo e($item->surname); ?></td>
                                                <td> <?php echo e($item->first_name); ?></td>
                                                <!--<td> {$item->empNumber}</td>-->

                                                <td> <?php echo e(date('d/m/Y', strtotime($item->startDate))); ?></td>
                                                <td> <?php echo e($item->jobdetails); ?></td>
												...
												?>
                                                        <a target="_blank" style="color: blue;cursor: pointer;"
                                                            data-toggle="modal" data-target="#cv<?php echo e($item->id); ?>">عرض
                                                            السيرة الذاتية</a>
                                                        <?php
													}else{
												?>
                                                        <a target="_blank" download href="<?php echo e(asset($item->cv)); ?>">عرض
                                                            السيرة الذاتية</a>
                                                        <?php } ?>

                                                        <!-- Modal -->
                                                        <div class="modal fade text-right" id="cv<?php echo e($item->id); ?>"
                                                            ...
                                                            <div class="modal-dialog" role="document">
                                                                <div class="modal-content">
                                                                    ...
                                                                    <div class="modal-body">
                                                                        ...
                                                                        <!--<iframe frameborder="0" style="min-height: 500px;overflow:scroll; width: 100%" scrolling="yes" src="<?php echo e(asset($item->cv)); ?>"></iframe>-->


                                                                        <object data="<?php echo e(asset($item->cv)); ?>"
                                                                            type="application/pdf">
                                                                            <embed src="<?php echo e(asset($item->cv)); ?>"
                                                                                type="application/pdf" />
                                                                        </object>
                                                                    </div>
                                                                    <div class="modal-footer">
                                                                        <a href="<?php echo e(asset($item->cv)); ?>" download>
                                                ...
                                                <td>
                                                    <button onclick="getEid(<?php echo e(json_encode($item)); ?>);"
                                                    ...
                                                    <button class="btn btn-sm btn-clean btn-icon btn-icon-md"
                                                        onclick="deleteempl(<?php echo e($item->id); ?>)"
                                                    ...
                                                    <button class="btn btn-sm btn-clean btn-icon btn-icon-md"
                                                        ...
                                                        data-toggle="modal" data-target="#employ<?php echo e($item->id); ?>"><i
                                                            class="fa fa-eye"></i>
                                                    </button>


                                                    <!-- Modal -->
                                                    <div class="modal fade text-right" id="employ<?php echo e($item->id); ?>"
                                                                        ...
                                                                        <div class="col-lg-12">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input type="text" class="form-control"
                                                                                    ...
                                                                                    value="<?php echo e($item->surname); ?>" readonly>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                        ...
                                                                        <div class="col-lg-6">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input type="text" class="form-control"
                                                                                    name="first_name"
                                                                                    placeholder="أدخل الاسم الأول"
                                                                                    value="<?php echo e($item->first_name); ?>"
                                                                                    readonly>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-lg-6">
                                                                            <div class="form-group edit-emp-number-div">
                                                                                ...
                                                                                <input type="text" name="empNumber"
                                                                                    ...
                                                                                    data-type="edit"
                                                                                    value="<?php echo e($item->empNumber); ?>"
                                                                                    readonly>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                        ...
                                                                        <div class="col-lg-6">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input name="startDate" max="2999-12-31"
                                                                                    ...
                                                                                    value="<?php echo e($item->startDate); ?>"
                                                                                    readonly>
                                                                            </div>
                                                                        </div>
                                                                        <div class="col-lg-6">
                                                                            <div class="form-group">
                                                                                <label>الوصف الوظيفي</label>
                                                                                <!-- <input type="text" name="jobdetails" class="form-control"  placeholder="Enter Job Details:" value="<?php echo e($item->jobdetails); ?>" readonly> -->
                                                                                <textarea name="jobdetails" id="" cols="20" rows="5" class="form-control"
                                                                                    placeholder="أدخل الوصف الوظيفي:"><?php echo e($item->jobdetails); ?></textarea>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                    <!-- <div class="row">
                            ...
                            <div class="kt-portlet__body table-responsive">
                                ...
                                <table
                                    ...
                                    <tbody>
                                        ...
                                        <?php $__currentLoopData = $employess; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                <!--<td> { item->skill_id} </td>-->
                                                <td> <?php echo e($item->empNumber); ?></td>
                                                <td> <?php echo e($item->surname); ?></td>
                                                <td> <?php echo e($item->first_name); ?></td>
                                                <!--<td> <?php echo e($item->empNumber); ?></td>-->
                                                <td> <?php echo e($item->empskill); ?></td>
                                                <td>
                                                    <button onclick="getEidskill(<?php echo e(json_encode($item)); ?>);"
                                                    ...
                                                    <button class="btn btn-sm btn-clean btn-icon btn-icon-md"
                                                        onclick="deleteemplskill(<?php echo e($item->skill_id); ?>)"
                                                        title="Delete Employee">
                                                        <span class="svg-icon svg-icon-md">
                                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                                xmlns:xlink="http://www.w3.org/1999/xlink" width="18px"
                                                    ...
                                                    <button class="btn btn-sm btn-clean btn-icon btn-icon-md"
                                                        title="View Customer Details" value="" o
                                                        data-toggle="modal" data-target="#skill<?php echo e($item->skill_id); ?>"><i
                                                            class="fa fa-eye"></i>
                                                    </button>


                                                    <!-- Modal -->
                                                    <div class="modal fade text-right" id="skill<?php echo e($item->skill_id); ?>"
                                                                        ...
                                                                        <div class="col-lg-6">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input type="text" class="form-control"
                                                                                    name="first_name"
                                                                                    placeholder="أدخل الاسم الأول"
                                                                                    value="<?php echo e($item->empskill); ?>"
                                                                                    readonly>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                            ...
                            <div class="kt-portlet__body table-responsive">
                                ...
                                <table
                                    ...
                                    <tbody>
                                        ...
                                        <?php $__currentLoopData = $emptraining; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                <td> <?php echo e($item->empNumber); ?></td>
                                                <td> <?php echo e($item->surname); ?></td>
                                                <td> <?php echo e($item->first_name); ?></td>
                                                ...
                                                <td> <?php echo e(date('d/m/Y', strtotime($item->startDate))); ?></td>
                                                <td> <?php echo e(date('d/m/Y', strtotime($item->traningdate))); ?> </td>
                                                <td> <?php echo e($item->traningdetails); ?></td>
                                                <td>
                                                    <button onclick="getEidtraining(<?php echo e(json_encode($item)); ?>);"
                                                        class="btn btn-sm btn-clean btn-icon btn-icon-md"
                                                        title="Edit"><span class="svg-icon svg-icon-md"> <span
                                                                class="svg-icon svg-icon-md"> <svg
                                                                    xmlns="http://www.w3.org/2000/svg"
                                                    ...
                                                    <button class="btn btn-sm btn-clean btn-icon btn-icon-md"
                                                        onclick="deleteempltraining(<?php echo e($item->traning_id); ?>)"
                                                        title="Delete Employee">
                                                        <span class="svg-icon svg-icon-md">
                                                            <svg xmlns="http://www.w3.org/2000/svg"
                                                                xmlns:xlink="http://www.w3.org/1999/xlink" width="18px"
                                                    ...
                                                    <button class="btn btn-sm btn-clean btn-icon btn-icon-md"
                                                        title="View Customer Details" value="" o
                                                        data-toggle="modal"
                                                        data-target="#training<?php echo e($item->traning_id); ?>"><i
                                                            class="fa fa-eye"></i>
                                                    </button>

                                                    <!-- Modal -->
                                                    <div class="modal fade text-right" id="training<?php echo e($item->traning_id); ?>"
                                                                        ...
                                                                        <div class="col-lg-6">
                                                                            <div class="form-group">
                                                                                ...
                                                                                <input type="text" class="form-control"
                                                                                    name="first_name"
                                                                                    placeholder="أدخل الاسم الأول"
                                                                                    value="<?php echo e($item->traningdate); ?>"
                                                                                    readonly>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                        ...
                                                                        <div class="col-lg-12">
                                                                            <div class="form-group edit-emp-number-div">
                                                                                ...
                                                                                <input type="text" name="empNumber"
                                                                                    required class="form-control"
                                                                                    data-type="edit"
                                                                                    value="<?php echo e($item->traningdetails); ?>"
                                                                                    readonly>
                                                                            </div>
                                                                        </div>
                                                                    </div>
                                                                <?php if($item->attach_cert): ?>
																<div class="row">
																	<div class="col-lg-12">
																		<div class="form-group edit-emp-number-div">
																			<label>شهادة التدريب</label><br>
																			<a href="<?php echo e($item->attach_cert); ?>" target="_blank">انقر للعرض</a>
																		</div>
																	</div>
																</div>
																<?php endif; ?>	
                                        ...
                                        <?php $__currentLoopData = $wp_users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $wpuser): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
										<?php $__currentLoopData = $wpuser; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $user): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
										<?php
										...
										?>
										<?php $__currentLoopData = $usercourses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $usercourse): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>

                                        <tr>
											<td><?php echo e($laravel_employee_detail->empNumber); ?></td>
                                            <td> <?php echo e($laravel_employee_detail->surname); ?></td>
											<td> <?php echo e($laravel_employee_detail->first_name); ?></td>
											<td><?php echo e($startdate); ?></td>
											<td><?php echo e($endate); ?></td>
											<td>
												
												   <li>
													<?php echo e($usercourse); ?>
    ...
    <div class="modal fade text-right" id="deleteSupplier" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <form action="<?php echo e(route('employess-delete')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
    ...
    <div class="modal fade text-right" id="editepmloyee" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form method="POST" action=" <?php echo e(route('editemployee')); ?> " enctype="multipart/form-data">
                    <?php echo csrf_field(); ?>
                    <div class="modal-body">
                        <div class="row">
    ...
    -->
                                    <!--    <?php $__currentLoopData = $userinfo; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
    -->
                                    <!--    <option value="<?php echo e($item->id); ?>" title="<?php echo e($item->first_name); ?>"><?php echo e($item->empNumber . ' (' . $item->first_name . ')'); ?></option>-->
                                    <!--
    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>-->
                                    <!--
    <?php endif; ?>-->
    ...
    <div class="modal fade text-right" id="editepmloyeeskills" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form method="POST" action="<?php echo e(route('update-employes-skill')); ?>">
                    <?php echo csrf_field(); ?>
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-lg-6">
    ...
    <div class="modal fade text-right" id="editepmloyeetraining" tabindex="-1" role="dialog"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form method="POST" action="<?php echo e(route('update-employes-training')); ?>">
                    <?php echo csrf_field(); ?>
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-lg-6">
...
<?php $__env->startSection('myscript'); ?>
    <script>
        ...
        let userId = "<?php echo e(\Illuminate\Support\Facades\Auth::id()); ?>";
        let type = '';
        let ajaxCall = null;
        $('input[name="empNumber"]').blur(function() {
            ...
            ajaxCall = $.ajax({
                method: 'get',
                url: '<?php echo e(url('/check-emp-number')); ?>',
                data: data,
...
<?php echo $__env->make('dashboard.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\myiso_ar\resources\views/dashboard/form_records/employess.blade.php ENDPATH**/ ?>