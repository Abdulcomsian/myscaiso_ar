                ...
                <div class="col-lg-12">
                    ...
                    <div class="procedure_div">
                        ...
                        <div class="managemnet_review_from_div">
                            <form action="<?php echo e(route('mgtreview')); ?>" method="POST" enctype="multipart/form-data">
                                <?php echo csrf_field(); ?>
                                <div class="row">
                                    <!-- <div class="col-lg-6">
                                    ...
                                    <tbody>
                                        ...
                                        <?php $__currentLoopData = $userData; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <tr>
                                                ...
                                                <td><?php echo $i; ?></td>
                                                <td> <?php echo e(date('d/m/Y', strtotime($item->reviewdate))); ?></td>
                                                <td> <?php echo e($item->meetingatt); ?></td>
                                                <td> <?php echo e($item->newquality); ?></td>
                                                <td>
                                                    <button class="btn btn-sm btn-clean btn-icon btn-icon-md"
                                                        title="Edit" value=""
                                                        onclick="displaydetail(<?php echo e(json_encode($item)); ?>);">
                                                        <i class="fa fa-eye"></i>
                                                    </button>
                                                    <button class="btn btn-sm btn-clean btn-icon btn-icon-md"
                                                        title="Edit" value=""
                                                        onclick="getEid(<?php echo e($item); ?>);"><span
                                                    ...
                                                    <button onclick="deleteData(<?php echo e($item); ?>)"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <form action="<?php echo e(route('deletemgtreview')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
    ...
    <div class="modal fade text-right" id="editSupplier" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?php echo e(route('mgtreviewupdate')); ?>" method="POST" enctype="multipart/form-data">
                        <?php echo csrf_field(); ?>
...
<?php echo $__env->make('dashboard.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\myiso_ar\resources\views/dashboard/form_records/managment_reviews.blade.php ENDPATH**/ ?>