                ...
                <div class="col-lg-12">
                    ...
                    <div class="procedure_div">
                        ...
                        <div class="customer_from_div">
                            <form action="<?php echo e(route('customerform')); ?> " id="addcust" method="POST">
                                <?php echo csrf_field(); ?>
                                <div class="row">
                                    <div class="col-lg-12">
                                        <h3> إضافة عملاء: </h3>
                                ...
                                <button onclick="customerForm()" type="reset"
                                    class="submitBtn"style="margin-right: 8px;">يلغي</button>
                            </form>
                        </div>
                    </div>
                    <div class="procedure_div">
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <button class="btn btn-sm btn-clean btn-icon btn-icon-md"
                                                        title="delete" value=""
                                                        onclick="deletethisitem(<?php echo e($item); ?>);"><svg
        ...
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?php echo e(route('editCustomers')); ?> " id="editcust" method="POST">
                        <?php echo csrf_field(); ?>
                        ...
                        <button type="button" class="submitBtn btn-secondary" data-dismiss="modal" aria-label="Close"
...
<?php echo $__env->make('dashboard.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\myiso_ar\resources\views/dashboard/form_records/customer.blade.php ENDPATH**/ ?>