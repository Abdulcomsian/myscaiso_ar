	...
	<script>
		...
		$('.enddate').datepicker({
		 ...
		 $(function() {
			...
			$.ajax({
				type: "get",
				url: `<?php echo e(route('fetch.users')); ?>\?id=${selectVal}`,
				success: function (response) {
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('admin.dashboard.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\myiso_ar\resources\views/admin/dashboard/admin/send_message.blade.php ENDPATH**/ ?>