...
<?php $__env->startSection('content'); ?>
            ...
            <div class="kt-portlet__head kt-portlet__head--lg">
				...
				<span class="kt-portlet__head-icon">
                    ...
                    <span style="margin-right: 15px;margin-top: 18px;">
                        <form action="<?php echo e(url('/view_user')); ?>" id="showuserform">
                        <select name="showusers" id="showusers">
                            <option value="0" <?php echo e(request('showusers') == 0 ? 'selected' : ''); ?>>كافة المستخدمين</option>
                            <option value="1" <?php echo e(request('showusers') == 1 ? 'selected' : ''); ?>>مستخدمو SCAISO</option>
                            <option value="2" <?php echo e(request('showusers') == 2 ? 'selected' : ''); ?>>مدرسة أديك</option>
                        </select>
                    </form></span>
                </div>
                    ...
                    <table class="table table-striped- table-bordered table-hover table-sm table-checkable"
                            ...
                            <!--<td><?php echo e($count); ?></td>-->
                                ...
                                <td><?php
                                    if (isset($item->profile_image)) { ?>
                                       ...
                                       <img src='<?php echo e($item->profile_image); ?>' width='60px'>
                                    <?php } ?></td>
                                ...
                                <td>
                                    ...
                                    <?php echo e(date('d/m/Y', strtotime($item->last_login))); ?>

                                    <?php } ?>
                                </td>

                                <td><?php echo e($minValue); ?> </td>
                                ...
                                onclick="get_downloads(<?php echo e($item->id); ?>);">
                                <i class="fa fa-download"></i>
                                </button>
                                <button class="btn btn-sm btn-clean btn-icon btn-icon-md" title="سجل تسجيل الدخول" value=""
                                onclick="get_history(<?php echo e($item->id); ?>);">
                                <i class="fas fa-sign-in-alt"></i>
                                </button>

                                
                                <button class="btn btn-sm btn-clean btn-icon btn-icon-md" title="تفاصيل تذكير النشاط" onclick="userEmailDetail(<?php echo e($item->id); ?>)">
                        ...
                        <button class="btn btn-sm btn-clean btn-icon btn-icon-md" title="تحرير العميل"
                                    ...
                                    <button class="btn btn-sm btn-clean btn-icon btn-icon-md"
                                            onclick="deleteUser(<?php echo e($item->id); ?>)" title="حذف العميل">
    ...
    <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        // $.ajax({
        //     type: "post",
        //     url: "<?php echo e(url('/userloginhistory')); ?>",
        ...
        function get_downloads(id) 
        {
            $.ajax({
                type: "post",
                url: "<?php echo e(url('/userdownloadhistory')); ?>",
                headers: { 'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content') },
                data: {
                    user_id: id,
                    _token: $('meta[name="csrf-token"]').attr('content')
        ...
        function userEmailDetail(id){
                $.ajax({
                    type: "post",
                    url: "<?php echo e(route('user.email.details')); ?>",
                    headers: { 'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content') },
                    data:{
                        user_id: id,
                        _token: $('meta[name="csrf-token"]').attr('content')
...
//console.log(data.company_address);
                ...
                // let logo_src = "https://myisoonline.me/public/" + data.profile_image;
                ...
                if (data.iso9001_certificate != null) {
                    ...
                    $(".iso9001").show();
                    $("#view_9001").append("<a target='_blank' href='https://myisoonline.me/public/" + data.iso9001_certificate + "'>تيقن</a>");
                } else {
                    $(".iso9001").hide();
                }
                if (data.iso14001_certificate != null) {
                    // $('#iso14001_certificate').addClass('has_file');
                    $("#view_4001").append("<a target='_blank' href='https://myisoonline.me/public/" + data.iso14001_certificate + "'>تيقن</a>");
                    $(".iso4001").show();
                } else {
                    $(".iso4001").hide();
                }
                if (data.iso45001_certificate != null) {
                    ...
                    $("#view_45001").append("<a target='_blank' href='https://myisoonline.me/public/" + data.iso45001_certificate + "'>تيقن</a>");
                    $(".iso45001").show();
            ...
            function viewDetails(data) 
            {
                ...
                if (data.iso9001_certificate != null) {
                    $("#v_9001").append("<a target='_blank' href='https://myisoonline.me/public/" + data.iso9001_certificate + "'>View</a>");
                } else {
                    $('#v_9001').append('Not Found');
                }
                if (data.iso14001_certificate != null) {
                    $("#v_4001").append("<a target='_blank' href='https://myisoonline.me/public/" + data.iso14001_certificate + "'>View</a>");
                } else {
                    $('#v_4001').append('Not Found');
                }
                if (data.iso45001_certificate != null) {
                    $("#v_45001").append("<a target='_blank' href='https://myisoonline.me/public/" + data.iso45001_certificate + "'>View</a>");
                } else {
...
<?php echo $__env->make('admin.dashboard.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\myiso_ar\resources\views/admin/dashboard/admin/view_user.blade.php ENDPATH**/ ?>